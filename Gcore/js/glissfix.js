...
(function (m) {
  function e(b, d, f, h, k) {
    ...
    var a = window.Glissfix = { prefixCSS: function prefixCSS(b, d, f) {
      ...
      var b = {},
          ...
          k = function k(a) {
        if ("-" === a.charAt(0)) {
          d.push(a);a = a.split("-");var c = a[1];for (b[c] = ++b[c] || 1; 3 < a.length;) {
        ...
        k(StyleFix.deCamelCase(c));
          ...
          p;for (p in b) {
        f = b[p], g < f && (e = p, g = f);
      }a.prefix = "-" + e + "-";a.Prefix = StyleFix.camelCase(a.prefix);a.properties = [];for (g = 0; g < d.length; g++) {
